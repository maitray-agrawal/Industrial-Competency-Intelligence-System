...
# Only ingest primary files (skip duplicates with uuid suffixes)
station_files = ["complete_trim_station_data.xlsx"]
tcf_files     = ["TCF_1.xlsx"]

for fname in station_files:
    fpath = os.path.join(UPLOAD_DIR, fname)
    if os.path.exists(fpath):
        print(f"\n[INGEST] Station data: {fname}")
